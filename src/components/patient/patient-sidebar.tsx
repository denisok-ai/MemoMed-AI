/**
 * @file patient-sidebar.tsx
 * @description Боковое меню пациента в стиле Admin: бургер на мобильных, sidebar на десктопе
 * @created 2026-02-22
 */
...
const NAV_ITEMS = [
  ...
  { href: '/medications', label: 'Лекарства', Icon: PillIcon },
  { href: '/journal', label: 'Дневник', Icon: BookIcon },
  { href: '/feedback', label: 'Отзывы', Icon: StarIcon },
  ...
  return (
    <>
      ...
      >
        ...
        <Logo href="/dashboard" variant="sidebar-compact" className="flex-1 justify-center" />
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6 lg:mb-8">
          <Logo href="/dashboard" variant="sidebar" onClick={closeSidebar} />
          <button
            type="button"
            onClick={closeSidebar}
